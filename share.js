...
as_share.whatsapp = function() {
    window.open('https://api.whatsapp.com/send?text=' + as_share.title + ' Website Create By ABDULLHA ❤❤❤    \n❤' + as_share.url, "_blank");
    as_share.close();
}
...
as_share.copyLink = function() {
    window.open('https://xylon.netlify.app/');
    as_share.close();
}
...
as_share_copyLink.innerHTML = "<i class='fas fa-fighter-jet'></i>";
